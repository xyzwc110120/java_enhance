package com.cyx.java_enhance.xml.dom;
...
public class DOMTest {
    ...
    private File file = new File("src/com.cyx.java_enhance.xml/students.com.cyx.java_enhance.xml");

    @Test
    public void testGetDocument() throws Exception {
        /*
            在 org.w3c.dom.Document 接口中，并没有获取该接口实现类对象的方法，需要通过 javax.com.cyx.java_enhance.xml.parsers.DocumentBuilder
            抽象类来获取 Document 对象，但是 DocumentBuilder 抽象类不能实例化，所以该类的实例要从
            javax.com.cyx.java_enhance.xml.parsers.DocumentBuilderFactory 抽象类中的 newDocumentBuilder() 方法获取，
    ...
    */
    ...
    public void createDocument() throws Exception {
        file = new File("src/com.cyx.java_enhance.xml/newStudents.com.cyx.java_enhance.xml");
